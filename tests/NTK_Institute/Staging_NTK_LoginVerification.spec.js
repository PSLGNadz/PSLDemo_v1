...
// 🔥 Fresh Context Helper - Ensures SignUp/Login tests always start clean
async function ensureFreshContext(page, context, url) {
...
// Set longer timeout for this complex flow
  ...
  // 🔥 Ensure completely fresh context (no auth reuse)
  await ensureFreshContext(page, context, config.ntkUrl);
